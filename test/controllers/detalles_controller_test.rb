...
class DetallesControllerTest < ActionController::TestCase
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post :create, detalle: { columna_id: @detalle.columna_id, producto_id: @detalle.producto_id, valor: @detalle.valor }
    end
  ...
  test "should update detalle" do
    patch :update, id: @detalle, detalle: { columna_id: @detalle.columna_id, producto_id: @detalle.producto_id, valor: @detalle.valor }
    assert_redirected_to detalle_path(assigns(:detalle))
  end
